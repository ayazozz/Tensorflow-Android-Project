...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String MODEL_FILE = "file:///android_asset/opt_demo_convnet.pb";
    ...
    private static final String INPUT_NODE = "conv2d_1_input"; // our input node
    private static final String OUTPUT_NODE = "dense_2/Softmax"; // our output node
...
try {
    ...
    if(bitmap == null)
    {
        InputStream file = assetManager.open("parfum245.jpg");
